...
# Introduction 
***A study conducted to see the data that is collected annually on whether the groundhogs see there shadows. How often do the groundhogs agree on an early spring over the a long winter? This data is provided by  groundhog-day.com. Data has been collected on the groundhog predictions since 1886. You can find out more about the dataset by inspecting their documentation, which you can access by running view(groundhogs) in the Console.***
